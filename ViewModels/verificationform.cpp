...
VerificationForm::VerificationForm(RegistrateDTO registrateDTO, QNetworkCookieJar *parentCookies, QWidget *parent) :
    QMainWindow(parent),
...
void VerificationForm::SetupVerificationRequest(RegistrateDTO registrateDTO, QString verificationCode){
